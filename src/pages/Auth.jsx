...
function Input({ label, type = 'text', value, onChange, placeholder, rightEl }) {
  return (
    <div className="flex flex-col gap-1.5">
      <label className="text-[11px] font-bold text-ios-label3 uppercase tracking-wider">{label}</label>
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center mb-5 sm:mb-8">
          <div
            className="w-12 h-12 sm:w-16 sm:h-16 rounded-[16px] sm:rounded-[20px] flex items-center justify-center mb-3 shadow-2xl"
            ...
            {['login', 'signup'].map((m) => (
              <button
                ...
                className={`flex-1 py-2 rounded-lg text-xs font-bold transition-all ${
                  mode === m ? 'bg-ios-card text-white shadow-md' : 'text-ios-label2'
                }`}
              >
