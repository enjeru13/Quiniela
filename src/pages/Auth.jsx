...
function ForgotView({ onBack }) {
    ...
    return (
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="flex flex-col items-center gap-4 py-6">
        ...
        <div className="text-center">
          <p className="text-base font-black text-white">Email enviado</p>
          <p className="text-sm text-ios-label2 mt-1 leading-relaxed">
            Revisa tu bandeja de entrada y sigue el link para crear tu nueva contraseña.
          </p>
        </div>
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      <p className="text-sm text-ios-label2 mb-5 leading-relaxed">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        />
        {error && (
          <motion.p initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }} className="text-xs font-semibold text-ios-red">
            {error}
          </motion.p>
        )}
        <button
...
// ── Reset password view (user arrived via email link) ─────────────────────────
function ResetView() {
      ...
      <div className="flex-1 overflow-y-auto flex items-center justify-center px-5 py-8">
        ...
        >
          <div className="flex flex-col items-center mb-6">
            <div
              className="w-14 h-14 rounded-2xl flex items-center justify-center mb-3 shadow-2xl"
              style={{ background: "linear-gradient(135deg, #0a84ff, #0066cc)" }}
            >
            ...
            <AnimatePresence mode="wait">
              {done ? (
                ...
                >
                  ...
                  <p className="text-sm text-ios-label2 text-center">Ingresando a tu cuenta...</p>
                </motion.div>
              ) : (
              ...
              {mode === "forgot" ? (
                ...
                <motion.div key="auth" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }}>
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    {success && (
                      <motion.p initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }} className="text-xs font-semibold text-ios-green">
                        {success}
                      </motion.p>
                    )}
